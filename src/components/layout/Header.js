        ...
        <section id="wilmer">
          <div className="w-full mx-auto bg-black">
            <div className="m-2 text-white">
              ...
              <span className="text-md">Estaremos recibiendo donaciones de víveres y frazadas en nuestras oficina Matriz, mismas que serán movilizadas a los albergues para los damnificados.</span>
            </div>
          </div>
        </section>
        <Navbar />
