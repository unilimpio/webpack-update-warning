...
export default function Header({siteVerOpts, langOpts,title, desc, banner, pathname, article, articleDate, product, category, categorySlug, productSku, productGtin13, offerPrice, brandName, brandLogo}) {
