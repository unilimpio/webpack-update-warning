...
<section id="product-line" className="pt-6 bg-gradient-to-br from-gray-300 via-white to-gray-300">
  <div className="container mx-auto">
    <h1 className="text-center sm:text-4xl text-4xl font-bold title-font mb-8">Soluciones para sector Educación</h1>
    <SplitSection className=""
        primarySlot={
          <div className="bg-white bg-opacity-50 rounded-xl p-10">
            <h2 className="text-xl text-primary-lighter mb-5">Las mejores soluciones pensadas para el bienestar del estudiate y docente.</h2>
            <p className="md:w-full text-left leading-relaxed text-base text-gray-700 text-justify ">
            Contamos con el más completo portafolio de productos de higiene institucional para garantizar el bienestar de la comunidad educativa. Tenemos todos los productos necesarios para cumplir con los protocolos de bioseguridad del segmento educativo, ofertas de valor que apoyan a que el regreso a clases sea seguro. Nuestro portafolio incluye productos de alta calidad que garantizan la efectiva sanitización y desinfección de superficies, así como implementos complementarios necesarios para cumplir con las normativas emitidas por las entidades regulatorias. <br/>
        ...
        secondarySlot={
          <PictureWebp className="float-right" path="" filename="soluciones-educacion" description="soluciones para industria educacion"/>
        }/>
